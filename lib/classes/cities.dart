...
class States{
  List<State> data;
  States(){
    data = cities["estados"].map((item) => 
      State(item["sigla"], item["nome"], item["cidades"])).toList();
  }

  List<String> getCities(String sigla){
    for(var i = 0; i < data.length; i++) {
      if (data[i].sigla==sigla)
        return data[i].cidades;
    }
